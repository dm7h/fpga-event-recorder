...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
		...
		/*
		// Endpoint address of the third CDC interface's device-to-host data IN endpoint. 
		#define CDC3_TX_EPADDR                 (ENDPOINT_DIR_IN  | 7)

		// Endpoint address of the third CDC interface's host-to-device data OUT endpoint. 
		#define CDC3_RX_EPADDR                 (ENDPOINT_DIR_OUT | 8)

		// Endpoint address of the third CDC interface's device-to-host notification IN endpoint. 
		#define CDC3_NOTIFICATION_EPADDR       (ENDPOINT_DIR_IN  | 9)
	...
	/* Type Defines: */
		...
		typedef struct
		{
			...
			USB_Descriptor_Endpoint_t                CDC3_ManagementEndpoint;

			// Third CDC Data Interface
