...
Ein Event liegt genau dann vor, wenn beide Werte gleich Null sind.\\
...
Die Implementierung der Event-Erkennung konnte aus zeitlichen Gründen leider nicht mehr ausreichend getestet werden.
