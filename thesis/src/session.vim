...
silent only
cd ~/code/fpga-event-recorder/thesis/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 deckblatt.tex
badd +0 thesis.tex
badd +0 einfuehrung.tex
badd +0 design.tex
badd +0 implementierung.tex
badd +0 anwendungsfall.tex
badd +0 fazit_aussciht.tex
badd +0 anhang_a.tex
badd +0 anhang_b.tex
argglobal
silent! argdel *
$argadd deckblatt.tex
set stal=2
edit deckblatt.tex
